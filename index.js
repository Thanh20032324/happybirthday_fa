const contentLetterSrart_actived = "Hi bố con đại diện cho những thành viên trong gia đình mình có món quà nho nhỏ gửi tặng đến bố người đàn ông trụ cột của gia đình. Khi mở tới dòng này bố nhớ mở loa điện thoại bố nhé." //Lời mở đầu cho bức thư
const mainContentLetter = "Sinh nhật bố, cả gia đình chúc bố có một ngày sinh nhật vui vẻ, luôn khỏe mạnh và hạnh phúc bên gia đình. Chúng con biết ơn bố vì tất cả những đóng góp và hy sinh của bố. Gia đình luôn yêu quý bố! Lời chúc sinh nhật bố đơn giản gửi đến bố yêu <3." //Nội dung của bức thư
